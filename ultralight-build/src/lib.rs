...
fn download_resources() {
    ...
    // linux builds do not have a libs dir
    #[cfg(target_os = "windows")]
    {
...
fn validate() -> bool {
    ...
    #[cfg(target_os = "linux")]
    let lib = target_dir.join("libUltralight.so");
    if !lib.exists() {
        return false;
    }
    #[cfg(target_os = "windows")]
    ...
    #[cfg(target_os = "linux")]
    let lib = target_dir.join("libUltralightCore.so");
    if !lib.exists() {
        return false;
    }
    #[cfg(target_os = "windows")]
    ...
    #[cfg(target_os = "linux")]
    let lib = target_dir.join("libAppCore.so");
    if !lib.exists() {
        return false;
    }
    #[cfg(target_os = "windows")]
    ...
    #[cfg(target_os = "linux")]
    let lib = target_dir.join("libWebCore.so");
    if !lib.exists() {
        return false;
    }
